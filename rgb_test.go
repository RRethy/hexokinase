...
func TestParseRGB(t *testing.T) {
	var tests = []testData{
		...
		{"rgb(0,0,255)rgb(176,253,35)  rgb(176,253,35)", []Colour{
			Colour{ColStart: 1, ColEnd: 12, Hex: "#0000ff"},
		...
		{"rgb(0,0,256)", []Colour{}},
		{"rgb(0,0,256)", []Colour{}},
		{"rgb(1000,1000,1000)", []Colour{}},

		// test handling of whitespace
		{" rgb(0,0,0) ", []Colour{
			Colour{ColStart: 2, ColEnd: 11, Hex: "#000000"},
		}},
		{" rgb(0,0,0) rgb(0,0,0) ", []Colour{
			Colour{ColStart: 2, ColEnd: 11, Hex: "#000000"},
