...
func TestParseRGBA(t *testing.T) {
	var tests = []testData{
		...
		{"rgba(256,0,0,1)", []Colour{}},
		{"rgba(0,0,256,1)", []Colour{}},
		{"rgba(0,0,256,1)", []Colour{}},
		{"rgba(1000,1000,1000,1)", []Colour{}},

		// test handling of whitespace
		{" rgba(0,0,0,1) ", []Colour{
			Colour{ColStart: 2, ColEnd: 14, Hex: "#000000"},
		}},
		{" rgba(0,0,0,1) rgba(0,0,0,1) ", []Colour{
			Colour{ColStart: 2, ColEnd: 14, Hex: "#000000"},
